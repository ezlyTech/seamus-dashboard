<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="../assets/img/Seamus-logo.png" class="navbar-brand-img h-100" alt="...">
            <span class="ms-3 font-weight-bold">Seamus Digital <br> Trading</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- BILLINGS --}}
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'billings' ? 'active' : '' }}"
                    href="{{ route('billings') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {{-- SHIPMENT --}}
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'shipment' ? 'active' : '' }}"
                    href="{{ route('shipment') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Shipment</span>
                </a>
            </li>
            ...
            {{-- SETTINGS --}}
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'general-settings' ? 'active' : '' }}"
